...
const Body = () => {
  ...
  const [showPopup, setShowPopup] = useState(true); // Set showPopup to true by default
  ...
  return listofRestaurants.length === 0 ? (
    ...
    <div>
    <div>
      {showPopup && <SubscribePopup onHide={handleHidePopup} />}
    </div>
      ...
      <div className="bg-gray-400 mx-40">
        <br></br>

        <div className="mt-7">
        <div className="font-handwritten text-3xl font-bold pl-4">
